...
namespace WebFormApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(OrderManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Users != null ? 
                          ...
                          Problem("Entity set 'OrderManagementContext.Users'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UserId,Email,Password")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
